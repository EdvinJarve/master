...
results_dir = os.path.join(project_root, 'monodomain_results', 'corner_case_smoother')
...
model = MonodomainSolverPINNs(
    num_inputs=3,  # x, y, t
    num_layers=2,  # Increased layers for better approximation
    num_neurons=512,  # Increased neurons per layer
    device=device,
