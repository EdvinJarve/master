...
plt.savefig(f"figures_bi_pinns/bi_corner_loss_for_epochs={epochs}.pdf")
plt.show()
...
for idx, time_point in enumerate(time_points):
    ...
    plt.tight_layout()
    plt.savefig(f"figures_bi_pinns/bi_corner_results_at_{time_point}.pdf")
    plt.show()
...
"""
Computation time (excluding visualization): 1681.64 seconds
