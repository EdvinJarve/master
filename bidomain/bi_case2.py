...
plt.savefig(f"bidomain_results/pinns_corner_loss_for_epochs={epochs}.pdf")
plt.close()
...
for t in time_points:
    ...
    plt.tight_layout()
    plt.savefig(f"bidomain_results/v_comparison_at_t_{t}.pdf")
    plt.close()
...
for t in time_points:
    ...
    plt.tight_layout()
    plt.savefig(f"bidomain_results/u_e_comparison_at_t_{t}.pdf")
    plt.close()
