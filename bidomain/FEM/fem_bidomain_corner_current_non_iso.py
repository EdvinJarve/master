...
# Define the diagonal conductivity matrix for intracellular space
D_i = ufl.as_matrix([[1.0, 0.0], [0.0, 0.0]])

# Define non-isotropic conductivity tensor for intracellular space
M_i = R.T * D_i * R
...
for idx, time_point in enumerate(time_points):
    ...
    ax.set_ylabel('y')
    plt.tight_layout()
    plt.savefig(f"figures_bi_fem/bi_corner_non_iso_results_at_{time_point}.pdf")
    plt.show()

"""

Computation time (excluding visualization): 1.12 seconds
