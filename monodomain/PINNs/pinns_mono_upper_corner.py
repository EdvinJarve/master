...
with an amplitude of 100. The conductivity tensor is set to be 1, making the current spread equally in all directions.
"""
...
def source_term(x, y, t, duration=0.2, current_value=50):
...
for pair in pairwise_time_points:
    ...
    plt.tight_layout()
    plt.savefig(f"figures_pinns_mono/Current_PINNs_solution_t{pair[0]}_t{pair[1]}.pdf")
    plt.show()

"""
Some results:

Epoch 7000, PDE Loss: 1.6249e-01, IC Loss: 7.1290e-03, BC Loss: 2.3922e-02, Total Loss: 1.9354e-01
Computation time (excluding visualization): 5114.07 seconds
